...
/**
 * DAO for table NATIVE_GAME.
 */
public class NativeGameDao extends AbstractDao<NativeGame, Long> {

    public static final String TABLENAME = "NATIVE_GAME";

    public NativeGameDao(DaoConfig config) {
        super(config);
    }
    ...
    public NativeGameDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'NATIVE_GAME' (" + //
                ...
                "'PACKAGE_NAME' TEXT," + // 24: package_name
                "'ORIGIN_NAME' TEXT," + // 25: origin_name
                "'OFFICIAL_URL' TEXT," + // 26: official_url
                "'MIN__SDK' INTEGER," + // 27: min_SDK
                "'TARGET__SDK' INTEGER);"); // 28: target_SDK
    }
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'NATIVE_GAME'";
        db.execSQL(sql);
    }
     ...
     */
    @Override
    protected void bindValues(SQLiteStatement stmt, NativeGame entity) {
        stmt.clearBindings();
        ...
        if (package_name != null) {
            stmt.bindString(25, package_name);
        }

        String origin_name = entity.getOrigin_name();
        if (origin_name != null) {
            stmt.bindString(26, origin_name);
        }

        String official_url = entity.getOfficial_url();
        if (official_url != null) {
            stmt.bindString(27, official_url);
        }

        Integer min_SDK = entity.getMin_SDK();
        if (min_SDK != null) {
            stmt.bindLong(28, min_SDK);
        }

        Integer target_SDK = entity.getTarget_SDK();
        if (target_SDK != null) {
            stmt.bindLong(29, target_SDK);
        }
    }
     ...
     */
    @Override
    public NativeGame readEntity(Cursor cursor, int offset) {
        NativeGame entity = new NativeGame( //
                ...
                cursor.isNull(offset + 24) ? null : cursor.getString(offset + 24), // package_name
                cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25), // origin_name
                cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26), // official_url
                cursor.isNull(offset + 27) ? null : cursor.getInt(offset + 27), // min_SDK
                cursor.isNull(offset + 28) ? null : cursor.getInt(offset + 28) // target_SDK
        );
        return entity;
    }
     ...
     */
    @Override
    public void readEntity(Cursor cursor, NativeGame entity, int offset) {
        ...
        entity.setPackage_name(cursor.isNull(offset + 24) ? null : cursor.getString(offset + 24));
        entity.setOrigin_name(cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25));
        entity.setOfficial_url(cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26));
        entity.setMin_SDK(cursor.isNull(offset + 27) ? null : cursor.getInt(offset + 27));
        entity.setTarget_SDK(cursor.isNull(offset + 28) ? null : cursor.getInt(offset + 28));
    }
     ...
     */
    @Override
    protected Long updateKeyAfterInsert(NativeGame entity, long rowId) {
     ...
     */
    @Override
    public Long getKey(NativeGame entity) {
        if (entity != null) {
    ...
    /**
     * Properties of entity NativeGame.<br/>
    ...
    public static class Properties {
        ...
        public final static Property Package_name = new Property(24, String.class, "package_name", false, "PACKAGE_NAME");
        public final static Property Origin_name = new Property(25, String.class, "origin_name", false, "ORIGIN_NAME");
        public final static Property Official_url = new Property(26, String.class, "official_url", false, "OFFICIAL_URL");
        public final static Property Min_SDK = new Property(27, Integer.class, "min_SDK", false, "MIN__SDK");
        public final static Property Target_SDK = new Property(28, Integer.class, "target_SDK", false, "TARGET__SDK");
    }
