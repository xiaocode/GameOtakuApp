...
public class ConfigUtils {
    public static final String PREFERENCE_NAME = "com.gameotaku.app";
...
//    public static HashMap<Long, String> getURLArray(Context context) {
//        HashMap<Long, String> urlList = new HashMap<Long, String>();
...
//    }
    ...
    public static void storeGameId(Context context, int index, long GameId) {
        setLong(context, KEY_GameId + index, GameId);
    }

    public static void clearGameId(Context context, int index) {
        setLong(context, KEY_GameId + index, 0L);
    }

    public static long getGameId(Context context, int index) {
        return getLong(context, KEY_GameId + index);
    }

    public static List<Long> getGameIdArray(Context context) {
        List<Long> GameIdList = new ArrayList<Long>();
        for (int i = 0; i < URL_COUNT; i++) {
            if (getGameId(context, i) != 0) {
                GameIdList.add(getLong(context, KEY_GameId + i));
            }
        }
        return GameIdList;
    }
