...
import com.gameotaku.app.authenticator.BootstrapAuthenticatorActivity;
import com.gameotaku.app.authenticator.LogoutService;
import com.gameotaku.app.core.PostFromAnyThreadBus;
import com.gameotaku.app.core.RestAdapterRequestInterceptor;
import com.gameotaku.app.core.RestErrorHandler;
import com.gameotaku.app.core.UserAgentProvider;
import com.gameotaku.app.db.DbHelper;
import com.gameotaku.app.service.BootstrapService;
import com.gameotaku.app.service.Constants;
import com.gameotaku.app.service.TimerService;
import com.gameotaku.app.ui.activity.BootstrapTimerActivity;
import com.gameotaku.app.ui.activity.MainActivity;
import com.gameotaku.app.ui.activity.NewsActivity;
import com.gameotaku.app.ui.activity.UserActivity;
import com.gameotaku.app.ui.fragment.CheckInsListFragment;
import com.gameotaku.app.ui.fragment.NavigationDrawerFragment;
import com.gameotaku.app.ui.fragment.NewsListFragment;
import com.gameotaku.app.ui.fragment.UserListFragment;
...
@Module(
        ...
        injects = {
                ...
                WebGameFragment.class,
                TimerService.class,

                AjustImageUtils.class,
                DbHelper.class
        }
)
