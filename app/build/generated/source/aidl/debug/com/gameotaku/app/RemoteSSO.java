 ...
 * Original file: /Users/Vincent/Github/GameOtakuApp/app/src/main/aidl/com/gameotaku/app/RemoteSSO.aidl
 */
package com.gameotaku.app;
public interface RemoteSSO extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.gameotaku.app.RemoteSSO
{
private static final java.lang.String DESCRIPTOR = "com.gameotaku.app.RemoteSSO";
...
/**
 * Cast an IBinder object into an com.gameotaku.app.RemoteSSO interface,
 * generating a proxy if needed.
 */
public static com.gameotaku.app.RemoteSSO asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.gameotaku.app.RemoteSSO))) {
return ((com.gameotaku.app.RemoteSSO)iin);
}
return new com.gameotaku.app.RemoteSSO.Stub.Proxy(obj);
}
...
private static class Proxy implements com.gameotaku.app.RemoteSSO
{
